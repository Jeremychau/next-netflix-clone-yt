...
import { BsFillPlayFill, BsFillArrowDownCircleFill } from "react-icons/bs"
        ...
        <div className="group bg-zinc-900 col-span relative h-[12vw]">
            ...
            ">
                ...
                <div className="flex flex-row items-center gap-3">
                    ...
                    >
                        <BsFillArrowDownCircleFill className="text-white group-hover/item:text-neutral-300 w-4 lg:w-6" />
                    </div>
                </div>
